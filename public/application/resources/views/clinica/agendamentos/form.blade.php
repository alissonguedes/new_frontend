							...
							<div class="row">
								<div class="col s6">
									<div class="input-field">
										...
										<input type="text" name="data" class="is_date white-text" value="{{ isset($row) && $row->data ? $row->data : null; }}" data-min-date="{{ date('d/m/Y') }}">
									</div>
								</div>
								<div class="col s6">
									<div class="input-field">
										<label for="local" class="white-text">Horário</label>
										<input type="text" name="hora" class="is_time white-text" value="{{ isset($row) && $row->hora ? $row->hora : null; }}">
									</div>
								</div>
							</div>
							<div class="row">
